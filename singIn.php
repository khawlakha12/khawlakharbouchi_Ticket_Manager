...
class Login extends Connection
{
    ...
    {
        $query = "SELECT * FROM developpeur WHERE email = '$email' AND password = '$password'";
    ...
    <section class="bg-indigo-500 dark:bg-gray-800 font-poppins">
        <div class="max-w-6xl px-4 mx-auto" x-data="{open:false}">
            <nav class="flex items-center justify-between py-3">
                <a href="#"><img src="img/logo H.T.S.png" alt="" class="h-10 w-28"></a>
                <div class="lg:hidden">
                    <button
        ...
        <form action="singIn.php" method="POST"
            ...
            <div class="border border-indigo-600 bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden"
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <button type="submit" value="Login"
                                        class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">SIGN
                                        IN</button>
                                </div>
                            </div>
                        </div>
